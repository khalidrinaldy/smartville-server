...
func GetBirthRegistrationById(db *gorm.DB) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		if result.RowsAffected == 0 {
			return c.JSON(http.StatusOK, helper.ResultResponse(true, "BirthRegistration Id Not Found", ""))
		}
...
func AddBirthRegistration(db *gorm.DB) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		if resultBirth.Error != nil {
			return c.JSON(http.StatusOK, helper.ResultResponse(true, resultBirth.Error.Error(), ""))
		}
